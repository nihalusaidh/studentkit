...
function Terms() {
  return (
    <div className="max-w-5xl mx-auto px-5 py-16">
      <Helmet>
        <title>Terms & Conditions | StudentKit</title>
        <meta name="description" content="Terms and Conditions for StudentKit." />
      </Helmet>
      ...
      <div className="space-y-8 text-slate-700 leading-8">
        <section>
          <h2 className="text-2xl font-bold mb-3">Use of StudentKit</h2>
          <p>
            StudentKit provides free online academic, image and PDF tools. By
        ...
        <section>
          ...
          <p>
            We try to provide accurate results, but StudentKit does not
        ...
        <section>
          ...
          <p>
            StudentKit is not responsible for data loss, file issues, academic
